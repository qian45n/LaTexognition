...
#from x_transformers_local.x_transformers.autoregressive_wrapper import AutoregressiveWrapper, top_k, top_p
#from x_transformers_local.x_transformers import TransformerWrapper, Decoder
from x_transformers.autoregressive_wrapper import AutoregressiveWrapper, top_k, top_p
from x_transformers import TransformerWrapper, Decoder
#from x_transformes_local.x_transformers import LinearAttentionTransformer
    ...
    return CustomARWrapper(
        TransformerWrapper(
            ...
            attn_layers=Decoder(
                ...
                heads=args.heads,
                linear_attn=args.linear_attn,
                **args.decoder_args
            )),
        pad_value=args.pad_token)
    # return CustomARWrapper(
    #     LinearAttentionTransformer(max_seq_len=args.max_seq_len, 
    #                                dim=256, 
    #                                depth=6),
    #     pad_value=args.pad_token)
